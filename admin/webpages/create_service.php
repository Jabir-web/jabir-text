                ...
                <div class="tab-content tab-content-basic">
                  ...
                  <div class="conatiner">
                    <div class="signup-form px-5">
                      ...
                      <form action="../logics/insert.php" method="post" id="serviceform" autocomplete="off">
                       
                        <div class="form-group">
                          <input type="text" name="service_name" class="form-control form-control-lg"
                            id="exampleInputEmail1" placeholder="Enter Service Name">

                        </div>
                        <div class="form-group">
                          <input type="text" name="service_fee" class="form-control form-control-lg"
                            id="exampleInputEmail1" placeholder="Enter Service Fee">
                        </div>
                     
                        <div class="mt-3">
                          <button class="btn btn-block btn-primary text-light btn-lg font-weight-medium auth-form-btn"
                            type="submit" id="servicebtn" name="serviceaddbtn">Add</button>
                        </div>
