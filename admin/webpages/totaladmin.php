                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a class="btn btn-success "
                                                                        href="update_users.php?userid=<?php echo $row['admin_id'] ?>">Edit</a>
                                                                </td>
                                                                <td>
                                                                    <!-- MODAL  -->
                                                                    <!-- Button trigger modal -->
                                                                    <button type="button" class="btn btn-danger"
                                                                        data-id="<?php $row['admin_id'] ?>"
                                                                        onclick="setEventId(<?php echo $row['admin_id'] ?>)"
                                                                        ...
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    Do you want to delete Staff <span
                                                                                        id="event_id"></span> ?
                                                                                </div>
