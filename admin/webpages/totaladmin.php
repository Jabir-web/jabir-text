    ...
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                ...
                $queryusers = "SELECT * FROM `admin` ORDER BY admin_id DESC";
                ...
                <div class="container">
                    <div class="totalusers p-5">
                        ...
                        <p class="mb-4">We Have <span class="text-primary fw-bold fs-4"><?php echo $totalusers ?></span> Users</p>
                            ...
                            <div class="col-md-2">
                                <a href="adminsignup.php" class="btn btn-primary">Create Admin</a>
                            </div>
                        </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <?php
                                                                    if (empty($row["admin_pic"])) {
                                                                        ...
                                                                        echo '<img src="../upload/admins/'.$row["admin_pic"].' " alt="Image"/>';
                                                                ...
                                                                <td>
                                                                    <?php echo $row['admin_businame'] ?>
                                                                </td>
                                                                <td>
                                                                    <?php echo $row['admin_pnumber'] ?>
                                                                </td>
                                                                <td>
                                                                <?php 
                                                                    $date=$row['admin_date'] ;
                                                                ...
                                                                <td>
                                                                    <a class="btn btn-success " href="update_users.php?userid=<?php echo $row['admin_id'] ?>">Edit</a>
                                                                </td>
                                                                <td>

<!-- MODAL  -->
<!-- Button trigger modal -->
<button type="button" class="btn btn-danger" data-id="<?php $row['admin_id'] ?>" onclick="setEventId(<?php echo $row['admin_id'] ?>)"
