  ...
  $(function() {
    if ($("#performaneLine").length) {
      ...
      var salesTopData = {
          ...
          datasets: [{
              label: 'This week',
              data: [300, 110, 60, 290, 200, 115, 130, 170, 90, 210, 240, 280, 200],
    ...
    if ($("#marketingOverview-dark").length) {
      ...
      var marketingOverviewDataDark = {
          ...
          datasets: [{
              label: 'Last week',
              data: [250, 220, 200, 190, 220, 110, 210, 110, 205, 202, 201, 150],
              backgroundColor: "#52CDFF",
              borderColor: [
                  '#52CDFF',
              ],
            ...
            label: 'This week',
            data: [25, 290, 210, 250, 290, 230, 290, 210, 280, 220, 190, 300],
            backgroundColor: "#1F3BB3",
            borderColor: [
                '#1F3BB3',
            ],
